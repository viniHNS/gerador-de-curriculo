    ...
    <form id="form" action="action_page.php" method="post">
        ...
        <div class="academic-info">
            ...
            <div class="grid">
                ...
                <input type="text" name="instituicao_academica[]">
                <input type="text" name="curso[]">
            </div>
            <div class="grid">
                <label for="data_inicio_academico">Data de início:</label>
                <label for="data_fim_academico">Data de término:</label>
                <input type="date" name="data_inicio_academico[]">
                <input type="date" name="data_fim_academico[]">
            </div>
            <div class="grid">
        ...
        <div class="professional-exp">
            ...
            <div class="grid">
                ...
                <input type="date" name="data_inicio_profissional[]">
                <input type="date" name="data_fim_profissional[]">
            </div>
            <div class="grid">
                <label for="atividades">Atividades:</label>
                <span style="display: flex; gap: 8px; align-items:center;">
                    <input type="checkbox" name="emprego_atual[]">
                    <p>É meu emprego atual</p>
                </span>
                <textarea name="atividades[]" cols="30" rows="10"></textarea>
            </div> 
        </div>
        ...
        <div class="certification">
            ...
            <div class="grid">
                ...
                <input type="text" name="certificacao[]">
                <input type="text" name="instituicao_certificado[]">
            </div>
            <div class="grid">
                <label for="data_inicio_certificacao">Data de início:</label>
                <label for="data_fim_certificacao">Data de término:</label>
                <input type="date" name="data_inicio_certificacao[]">
                <input type="date" name="data_fim_certificacao[]">
            </div>
            <div class="grid">
                <label for="carga_horaria">Carga horária (em horas)</label>
                <span></span>
                <input type="text" inputmode="numeric" name="carga_horaria[]" class="carga_horaria">
            </div>
        </div>
            <span style="display: flex; justify-content:end;">
